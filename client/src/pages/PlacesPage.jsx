            ...
            {action === 'new' && (
                <div>
                    <form action="">
                        ...
                        <h2 className="text-2xl mt-4">Ad dressclas sesclassName</h2>
                        ...
                        <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
                            ...
                            <label className = "border p-4 flex rounded-2xl gap-2 items- cursor-pointer">
                                <input type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <p className="text-gray-500 text-sm">add check in and out times, remember to hae some time window for cleaning the room between guests</p>
