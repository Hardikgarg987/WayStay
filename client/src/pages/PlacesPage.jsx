            ...
            {action === 'new' && (
                <div>
                    <form action="">
                        ...
                        <input type="text" value={address} onChange={ev => setTitle(ev.target.value)} placeholder="address" />
                        ...
                        <div className="grid gap-2 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" value={checkIn} onChange={ev => setCheckOut(ev.target.value)} placeholder="11"/>
                            </div>
                            <div>
